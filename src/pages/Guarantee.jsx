      ...
      <div className="container">
        ...
        <div className="guarantee">
          <div className="guarantee_item">
            <img src="./icons/guarantee1.svg" alt="" />
          ...
          <div className="guarantee_item">
            <img src="./icons/guarantee2.svg" alt="" />
            <div className="guarantee_text">
              <h2>{words.best}</h2>
              <p>{words.love}</p>
            </div>
          ...
          <div className="guarantee_item">
            <img src="./icons/guarantee3.svg" alt="" />
            <div className="guarantee_text">
              <h2>{words.happy}</h2>
              <p>{words.dontLike}</p>
            </div>
          ...
          <div className="guarantee_item">
            <img src="./icons/guarantee4.svg" alt="" />
            <div className="guarantee_text">
              <h2>{words.online}</h2>
              <p>{words.ready}</p>
            </div>
          ...
          <div className="guarantee_item">
            <img src="./icons/guarantee5.svg" alt="" />
            <div className="guarantee_text">
